...
internal sealed class CustomerPlugin
{
    ...
    /// </summary>
    [KernelFunction, Description("Given the Contoso books customer e-mail address, return their profile information including name, age, location, a list of interests and a CSV containing their recent purchases and searches from Contoso books")]
    public string GetCustomerProfileAndRecentPurchases(
